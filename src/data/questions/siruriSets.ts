...
export const siruriSetExercises: Exercise[] = [
  ...
  },
  {
    ...
    type: "input",
    points: 6,
    prompt: "Fie progresia geometrică $(b_n)$ cu $b_1=7$ și $b_4=189$. Determinați rația pozitivă $q$.",
    correctAnswer: "3",
    explanation: [
      "Împărțim: $\\dfrac{b_4}{b_1}=q^3$, adică $\\dfrac{189}{7}=q^3$.",
      "Rezultă $q^3=27$, deci $q=3$.",
    ],
  },
  {
    ...
    type: "input",
    points: 6,
    prompt: "Fie progresia geometrică $(b_n)$ cu rația $q=2$ și $b_4=48$. Determinați primul termen $b_1$.",
    correctAnswer: "6",
    explanation: [
      "Din $b_4=b_1\\cdot q^3$, rezultă $b_1=\\dfrac{b_4}{q^3}=\\dfrac{48}{8}$.",
      "Calculăm: $b_1=6$.",
    ],
  },
  {
    ...
    type: "input",
    points: 6,
    prompt: "Fie progresia geometrică $(b_n)$ cu $b_1=3$ și $b_3=75$. Determinați rația pozitivă $q$.",
    correctAnswer: "5",
    explanation: [
      "Împărțim: $\\dfrac{b_3}{b_1}=q^2$, adică $\\dfrac{75}{3}=q^2$.",
  ...
  },
  {
    ...
    type: "input",
    points: 6,
    prompt: "Fie progresia geometrică $(b_n)$ cu rația $q=3$ și $b_3=81$. Determinați primul termen $b_1$.",
    correctAnswer: "9",
    explanation: [
      "Din $b_3=b_1\\cdot q^2$, rezultă $b_1=\\dfrac{b_3}{q^2}=\\dfrac{81}{9}$.",
      "Calculăm: $b_1=9$.",
    ],
  },
  {
