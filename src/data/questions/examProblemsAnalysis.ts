    ...
    subpoints: [
      {
        ...
        correctAnswer: "0",
        explanation: "$F(x) = x^3 - 1x^2 + C$, iar $F(0)=0 \\Rightarrow C=0$. Deci $F(1) = 1 - 1 = 0$.",
      },
      {
        id: "ea-in-1-b",
        label: "b",
        ...
        options: ["$x^3 - 1x^2 + C$", "$3x^3 - 2x^2 + C$", "$x^3 + 1x^2 + C$", "$6x - 2 + C$"],
        correctAnswer: "$x^3 - 1x^2 + C$",
        explanation: "$(x^3 - 1x^2)' = 3x^2 - 2x = f(x)$.",
      },
      {
        id: "ea-in-1-c",
        label: "c",
        ...
        correctAnswer: "4",
        explanation: "$\\int_0^2 (3x^2-2x)\\,dx = \\left[x^3 - 1x^2\\right]_0^2 = (8-4) - 0 = 4$.",
      },
    ],
  },
  {
